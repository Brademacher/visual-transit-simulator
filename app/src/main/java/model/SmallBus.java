...
/**
 * A small bus representation on the transit simulator.
 */
public class SmallBus extends Bus {

  /** A string used for creating a small bus json object. */
  public static final String SMALL_BUS_VEHICLE = "SMALL_BUS_VEHICLE";

  /** A string used for setting the speed of a small bus object. */
  public static final double SPEED = 0.5;

  /** A string used for setting the passenger capacity of a small bus object. */
