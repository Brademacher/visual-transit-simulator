...
/**
 * Represents an Electric Train in the transit system.
 */
public class ElectricTrain extends Train {
  /**
   * Used for creating an electric train json object.
   */
  public static final String ELECTRIC_TRAIN_VEHICLE = "ELECTRIC_TRAIN_VEHICLE";

  /**
   * Used for setting the speed of an electric train object.
   */
  public static final double SPEED = 1;

  /**
   * Used for setting the passenger capacity of an electric train object.
   */
