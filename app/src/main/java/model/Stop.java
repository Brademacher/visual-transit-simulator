...
/**
 * Represents a stop in the transit system where passengers can wait
 * and vehicles can load or unload them.
 */
public class Stop {
  private int id;
  private String name;
   ...
   *
   * @return int representing the stop ID.
   */
  public int getId() {
    return id;
  }
   ...
   *
   * @return string of the stop name.
   */
  ...
  /**
   * Gets the position of the stop (longitude, latitude).
   *
