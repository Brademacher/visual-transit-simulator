...
/**
 * Represents a Large Bus on the transit simulator.
 */
public class LargeBus extends Bus {

  /** A string used for creating a large bus json object. */
  public static final String LARGE_BUS_VEHICLE = "LARGE_BUS_VEHICLE";

  /** A string used for setting the speed of a large bus object. */
  public static final double SPEED = 0.5;

  /** A string used for setting the passenger capacity of a large bus object. */
