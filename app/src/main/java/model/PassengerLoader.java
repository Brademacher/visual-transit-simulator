...
/**
 * Responsible for loading passengers onto a vehicle.
 * Ensures the vehicle does not exceed its maximum passenger capacity.
 */
public class PassengerLoader {
   ...
   * Currently, this is either {@code 1} or {@code 0}: either passenger was added or they
