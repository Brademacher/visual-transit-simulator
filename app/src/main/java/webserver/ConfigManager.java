...
/**
 * Reads and parses the simulation configuration file,
 * defining lines, routes, stops, and storage capacities.
 */
public class ConfigManager {
  ...
  /**
   * Simple method to reset the vehicle fields in the storage facility.
   */
