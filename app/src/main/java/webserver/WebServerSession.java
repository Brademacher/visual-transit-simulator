...
/**
 * Represents a WebSocket session for the Visual Transit Simulator.
 * Handles messages from the client and sends simulation data back.
 */
@ServerEndpoint(
    value = "/simulator",
...
public class WebServerSession {
  ...
  /**
   * Default constructor for WebServerSession.
   */
